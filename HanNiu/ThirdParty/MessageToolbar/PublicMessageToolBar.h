...
#import "PublicMessageTextView.h"
...
@protocol PublicMessageToolBarDelegate;
@interface PublicMessageToolBar : UIView

@property (nonatomic, weak) id <PublicMessageToolBarDelegate> delegate;
 ...
 *  用于输入文本消息的输入框
 */
@property (strong, nonatomic) PublicMessageTextView *inputTextView;
...
@protocol PublicMessageToolBarDelegate <NSObject>
