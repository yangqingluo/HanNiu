...
@interface PublicMessageToolBar()<UITextViewDelegate, DXFaceDelegate>
{
    CGFloat _previousTextViewContentHeight;//上一次inputTextView的contentSize.height
}

@property (nonatomic) CGFloat version;
@property (nonatomic) ToolButtonType toolButtonType;
...
- (void)setupSubviews {
    ...
    // 初始化输入框
    self.inputTextView = [[PublicMessageTextView alloc] initWithFrame:CGRectMake(textViewLeftMargin, kVerticalPadding, width, kInputTextViewMinHeight)];
...
//    _inputTextView.layer.cornerRadius = 6.0f;
    ...
    if (self.toolButtonType == ToolButtonTypeAll) {
    ...
    else if (self.toolButtonType == ToolButtonTypeFaceOnly){
        ...
        allButtonWidth = CGRectGetWidth(self.bounds) - CGRectGetMinX(self.faceButton.frame) + kHorizontalPadding * 1.5;
//        width = CGRectGetWidth(self.bounds) - (allButtonWidth ? allButtonWidth : textViewLeftMargin);
        self.inputTextView.frame = CGRectMake(kHorizontalPadding, kVerticalPadding, CGRectGetWidth(self.bounds) - allButtonWidth, kInputTextViewMinHeight);
    }
