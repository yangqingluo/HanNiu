...
- (QCSlideSwitchView *)slidePageView{
    if (!_slidePageView) {
        _slidePageView = [[QCSlideSwitchView alloc] initWithFrame:CGRectMake(0, self.adHeadView.bottom + kEdge, self.view.width, self.view.height - TAB_BAR_HEIGHT - (self.adHeadView.bottom + kEdge)) withHeightOfTop:88.0];
